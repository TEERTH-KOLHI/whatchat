...
import { User, Lock, UserPlus, Phone, MessageCircle, Globe, AtSign, LogIn, ChevronDown } from 'lucide-react';
import Link from 'next/link';
import { useState } from 'react';

// Countries list moved outside component to avoid recreation
const COUNTRIES = [
                ...
                <form className="auth-form" onSubmit={(e) => e.preventDefault()}>
                    ...
                    <div className="form-row">
                        <div className="form-group" style={{ flex: '1' }}>
                            ...
                            <div className="input-with-icon custom-dropdown-container">
                                <Globe size={20} className="input-icon" />
                                <ChevronDown size={16} className={`select-arrow ${isDropdownOpen ? 'rotate-180' : ''}`} />

                                <div
                                    className="auth-select custom-select-trigger"
                                        ...
                                        <div className="dropdown-list">
                                            {filteredCountries.map((country) => (
                                                <div
                                                    ...
                                                    className={`dropdown-item ${country.code === countryCode ? 'selected' : ''}`}
                                                    onClick={() => {
