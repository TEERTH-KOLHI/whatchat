...
import { Search, Filter, MessageSquare, Settings, Facebook } from 'lucide-react';
                        ...
                        {[1, 2, 3].map((i) => (
                            <tr key={i} style={{ borderBottom: '1px solid #f9fafb' }}>
                                <td style={{ padding: '1rem' }}>
                                    <div style={{ width: '60px', height: '60px', background: '#f3f4f6', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                        <Facebook size={24} color="#1877f2" />
                                    </div>
                                </td>
                                <td style={{ padding: '1rem', maxWidth: '300px' }}>
                                    <div style={{ fontWeight: '500', color: '#1f2937' }}>Check out our new summer collection! ☀️</div>
                                    <div style={{ fontSize: '0.8rem', color: '#9ca3af', marginTop: '0.25rem' }}>Posted on Oct {10 + i}, 2024</div>
                                </td>
