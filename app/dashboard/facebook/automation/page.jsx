...
import { Search, Filter, MessageSquare, Settings, Facebook, X, Check, Save } from 'lucide-react';
...
export default function FacebookAutomationPage() {
    ...
    const fetchPosts = async () => {
        setLoading(true);
        try {
            const res = await fetch('/api/facebook/automation');
        ...
        <div className="dashboard-page" style={{ position: 'relative' }}>
                ...
                <div style={{
                    ...
                    <div style={{ background: 'white', padding: '2rem', borderRadius: '8px', width: '500px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
                            <h3 style={{ margin: 0 }}>Configure Auto-Reply</h3>
                        ...
                        <div style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
                            <label className="switch" style={{ position: 'relative', display: 'inline-block', width: '50px', height: '26px' }}>
                                ...
                                <span style={{
                                    ...
                                    backgroundColor: isEnabled ? '#10b981' : '#ccc', borderRadius: '34px', transition: '.4s'
                                }}></span>
                                <span style={{
                        ...
                        <div style={{ marginBottom: '1.5rem', opacity: isEnabled ? 1 : 0.5, pointerEvents: isEnabled ? 'auto' : 'none', transition: 'opacity 0.2s' }}>
                            ...
                            <textarea
                                ...
                                placeholder="Thank you for your comment! Send us a DM for more info."
                                rows={4}
                        ...
                        <button
                            ...
                            disabled={saving}
                            style={{ width: '100%', padding: '0.8rem', background: '#1877f2', color: 'white', border: 'none', borderRadius: '4px', fontWeight: 'bold', cursor: 'pointer', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem' }}>
            ...
            <div className="page-header-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                <div>
                    ...
                    <p style={{ margin: 0, color: '#6b7280', fontSize: '0.95rem' }}>Auto-reply to comments on your Facebook posts</p>
                </div>
            </div>
                                ...
                                posts.map((post) => (
                                    <tr key={post.id} style={{ borderBottom: '1px solid #f9fafb' }}>
                                        <td style={{ padding: '1rem' }}>
                                            <div style={{ width: '50px', height: '50px', background: '#e0f2fe', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
