...
export default function FacebookLiveChatPage() {
    ...
    const fetchConversations = async () => {
        setLoading(true);
        try {
            const res = await fetch('/api/conversations?channel=facebook');
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            fetchMessages(activeChat.id); // Refresh to get real ID and ordering
    ...
    const handleResolve = () => {
        alert("This chat would be marked as resolved in a real CRM.");
    };
            ...
            <div style={{ width: '350px', borderRight: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column' }}>
                <div style={{ padding: '1rem', borderBottom: '1px solid #f3f4f6' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                        ...
                        <button style={{ padding: '0.25rem 0.75rem', borderRadius: '999px', background: 'white', border: '1px solid #e5e7eb', fontSize: '0.85rem', color: '#6b7280', cursor: 'pointer' }}>Unread</button>
                    </div>
                </div>
                ...
                <div style={{ flex: 1, overflowY: 'auto' }}>
                    {loading ? (
                        ...
                        <div style={{ padding: '1rem', textAlign: 'center', color: '#6b7280' }}>No Facebook conversations found.</div>
                    ) : (
